...
export KERNEL_PATH
$(call inherit-product, device/sprd/roc1/ud710_2h10/ud710_2h10_Base.mk)
...
CHIPRAM_DEFCONFIG := ud710_2h10
UBOOT_DEFCONFIG := ud710_2h10
UBOOT_TARGET_DTB := ud710_2h10
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ud710_2h10.xml:$(PRODUCT_OUT)/ud710_2h10.xml
...
SOFTWARE_INTERNAL_VERSION :=S813_JingPad_C1_$(shell date +%Y%m%d_%H%M)_uMCP
