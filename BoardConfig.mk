...
OV5675_VCM_OTP_DUAL_CAM_ONE_EEPROM := true
TARGET_BOARD_ROC1_OV5675_TUNING_PARAM := true
#camera dual sensor
...
# for the compatible to board with ufs and emmc device
#BOARD_COMPATYIBLE_UFS_EMMC_SPL := --board_compatible
